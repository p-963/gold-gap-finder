...
> **Can this opportunity realistically be reached, built and tested by this founder?**
...
Research is not the same as validation.

Before investing heavily in a build, test the strongest remaining assumptions through real-world actions such as:

- customer conversations
- landing-page tests
- payment or pricing tests
- manual/no-code experiments
